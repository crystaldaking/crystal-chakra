//! Git-aware Java syntax indexing adapter.
//!
//! The adapter extracts syntax-tier Java facts through the official
//! Tree-sitter Java grammar (ADR-0027): one grammar covers `.java` sources.
...
pub use discovery::{
    DiscoveryError, discover_java_files, discover_java_sources, resolve_repository_root,
};
pub use indexer::{
    IndexMetrics, IndexReport, JavaIndexError, JavaSources, JavaSyntaxIndex, LanguageBuildMetrics,

...
use chakra_domain::indexing::IndexingDiagnostics;
use chakra_domain::operation::OperationContext;
use chakra_engine::{FreshnessBarrier, FreshnessBarrierError};

use super::metrics::MetricsState;
use super::{FRESHNESS_CANCELLATION_POLL, FRESHNESS_TIMEOUT, LiveIndexDiagnostics, WorkerSignal};
...
pub(super) struct LiveFreshnessBarrier {
    ...
    pub(super) diagnostics: Arc<LiveIndexDiagnostics>,
}

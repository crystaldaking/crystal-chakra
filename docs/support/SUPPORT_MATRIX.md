...
Target list reviewed: 2026-09 (GitHub Octoverse 2025 top languages plus pre-existing Chakra support; kotlin is a maintainer-accepted v0.4.0 addition (issue #209), not a top-10 claim)
...
| PRECISE-02 | pass | Current-candidate real-provider tests pass for Maven, Gradle JVM, Android, mixed Kotlin/Java and Multiplatform. They verify KotlinLsp provenance, revision-bound incoming/outgoing calls, overload exclusions, Java-only synchronization and KMP source-root reimport. Semantic definitions/references bind KMP and mixed-language calls; incomplete models truncate explicitly and composite imports fail honestly. |
...
| QUERY-02 | pass | chakra-mcp structured tools |
| QUERY-03 | pass | chakra-git worktree/base-ref diff provider for .kt/.kts files |
| SYNTAX-01 | pass | tree-sitter-kotlin-ng 1.1.0 (tree-sitter-language ABI, ADR-0056) |
| SYNTAX-02 | pass | tree-sitter classes, interfaces, objects, companions, enum entries, properties, constructors, type aliases, extension receivers, and annotations |
| SYNTAX-03 | pass | tree-sitter package/file modules and class containers |
| SYNTAX-04 | pass | tree-sitter import aliases |
| SYNTAX-05 | pass | tree-sitter byte-accurate declarations and call ranges with Unicode scalar conversion |
| SYNTAX-06 | pass | @Test function hints in test sources |
| SYNTAX-07 | pass | tree-sitter diagnostics with retained valid declarations |
| SYNTAX-08 | pass | bounded member, nullsafe-member, and function call candidates |
